            ...
            return (
              ...
              >
                <div className={`relative overflow-hidden rounded-[1.5rem] p-1 shadow-xl transition-all duration-300 ${
                  ...
                  {isComingSoon && (
                    <div className="absolute top-3 right-3 z-20 bg-amber-500 text-white text-[8px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest shadow-lg">
                      Coming Soon
                    </div>
                  )}
                  ...
                  <div className="relative z-10 bg-white/10 backdrop-blur-xl rounded-[1.3rem] px-4 py-3.5 border border-white/10 flex items-center gap-3">
                    ...
                    {!isComingSoon && (
                      <span className="text-white/40 text-xs font-bold flex-shrink-0">{ch.mcq_count} Qs</span>
                    )}
                  </div>
                </div>
              </motion.div>
