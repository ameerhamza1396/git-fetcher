  ...
  if (isErrorResult) {
    return (
      <div className="text-center text-red-500 mt-8">
        ...
        <br /><Link to="/dashboard"><Button className="mt-4"> Dasboard </Button></Link>
      </div>
    );
  }
  if (isErrorMcqs) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 dark:bg-gradient-to-br dark:from-gray-900 dark:via-purple-900/10 dark:to-pink-900/10 p-4 sm:p-8">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6">
          <Link to="/dashboard" className="mb-4 sm:mb-0">
            <Button variant="outline" className="w-full sm:w-auto flex items-center bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 border-gray-300 dark:border-gray-600">
        ...
        <Card className="mb-8 p-6 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-purple-950/20 shadow-lg border border-purple-100 dark:border-purple-800/50">
          ...
          <CardContent className="flex flex-col h-full justify-between items-center text-center p-0"> {/* Adjusted p-0 as Card already has p-6 */}

            {/* Content area that should grow and push the button down */}
            <div className="flex-grow flex flex-col justify-center items-center w-full"> {/* Added w-full */}
                ...
                <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-4 w-full"> {/* Removed margin-bottom here, will add to the container above */}
            ...
            <div className="mt-8 pt-4 border-t border-gray-200 dark:border-gray-700 w-full"> {/* Added w-full */}
              {flpResult && mcqsData && (
